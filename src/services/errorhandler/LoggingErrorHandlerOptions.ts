// reference: http://www.bennadel.com/blog/3138-creating-a-custom-errorhandler-in-angular-2-rc-6.htm
...
export class LoggingErrorHandler implements ErrorHandler {
    ...
    constructor(errorLogService: ErrorLogService, @Inject(LOGGING_ERROR_HANDLER_OPTIONS) options: LoggingErrorHandlerOptions) {
    ...
    public handleError(error: any): void {
        ...
        try {
            ...
            this.options.unwrapError ? this.errorLogService.logError(this.findOriginalError(error)) : this.errorLogService.logError(error);

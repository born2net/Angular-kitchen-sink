System.register(['@angular/core', "../../sliderpanel/Sliderpanel", "../../../services/CommBroker", "./NotesBase", "../../minitabs/Minitab", "../../minitabs/Minitabs", "./StarWarsSearch", "./WikiSearch", "./InfinityScroll", "./Clock", "./MultiSlotTransclusion", "./CompFactory"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, Sliderpanel_1, CommBroker_1, NotesBase_1, Minitab_1, Minitabs_1, StarWarsSearch_1, WikiSearch_1, InfinityScroll_1, Clock_1, MultiSlotTransclusion_1, CompFactory_1;
    var Notes3;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            Notes3 = (function (_super) {
                ...
                Notes3 = __decorate([
                    core_1.Component({
                        selector: 'Notes3',
                        directives: [Minitab_1.Minitab, Minitabs_1.Minitabs, StarWarsSearch_1.StarWarsSearch, WikiSearch_1.WikiSearch, InfinityScroll_1.InfinityScroll, Clock_1.Clock, MultiSlotTransclusion_1.MultiSlotTransclusion, CompFactory_1.CompFactory],

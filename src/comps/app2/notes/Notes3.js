System.register(["@angular/core", "../../sliderpanel/Sliderpanel", "../../../services/CommBroker", "./NotesBase", "../../minitabs/Minitab", "../../minitabs/Minitabs", "./StarWarsSearch", "./WikiSearch", "./InfinityScroll", "./Clock", "./MultiSlotTransclusion", "./CompFactory", "./EmbedView", "./DynamicWebImport", "./CompBuilder", "./CompElemBuilder", "./CreateEmbedDiffer", "./ToggleButton", "./StreamButton", "../../ngForIf/ngBookRepeat"], function(exports_1, context_1) {
    ...
    var core_1, Sliderpanel_1, CommBroker_1, NotesBase_1, Minitab_1, Minitabs_1, StarWarsSearch_1, WikiSearch_1, InfinityScroll_1, Clock_1, MultiSlotTransclusion_1, CompFactory_1, EmbedView_1, DynamicWebImport_1, CompBuilder_1, CompElemBuilder_1, CreateEmbedDiffer_1, ToggleButton_1, StreamButton_1, ngBookRepeat_1;
    var Notes3;
    return {
        setters:[
            function (core_1_1) {
                ...
                Notes3 = __decorate([
                    core_1.Component({
                        ...
                        directives: [Minitab_1.Minitab, Minitabs_1.Minitabs, StarWarsSearch_1.StarWarsSearch, WikiSearch_1.WikiSearch, InfinityScroll_1.InfinityScroll,
                            ...
                            CompBuilder_1.CompBuilder, CompElemBuilder_1.CompElemBuilder, CreateEmbedDiffer_1.CreateEmbedDiffer, ToggleButton_1.ToggleButtonApp, StreamButton_1.StreamButton, ngBookRepeat_1.ngBookRepeatSample],

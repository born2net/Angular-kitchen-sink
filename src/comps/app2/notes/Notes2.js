System.register(['@angular/core', "../../sliderpanel/Sliderpanel", "../../modaldialog/ModalDialog", "../../../services/CommBroker", "./NotesBase", "../../myip/Myip", "ng2-bs3-modal/ng2-bs3-modal", "../../trimmedinput/TrimmedInput"], function(exports_1, context_1) {
    ...
    var core_1, Sliderpanel_1, ModalDialog_1, CommBroker_1, NotesBase_1, Myip_1, ng2_bs3_modal_1, TrimmedInput_1;
    var Notes2;
    return {
        setters:[
            function (core_1_1) {
            ...
            Notes2 = (function (_super) {
                ...
                Notes2 = __decorate([
                    core_1.Component({
                        ...
                        directives: [TrimmedInput_1.TrimmedInput, Myip_1.MyIp, ModalDialog_1.ModalDialog, ModalDialog_1.ModalDialog, ng2_bs3_modal_1.MODAL_DIRECTIVES],

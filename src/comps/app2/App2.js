System.register(['angular2/core', 'angular2/router', "../sideMenu/MenuItem", "../sideMenu/Menu", "../../services/CommBroker", "../../Conts", "../sliderpanel/Sliderpanel", "./properties/Properties", "./notes/Notes1", "./notes/Notes2", "./notes/Notes3", "./notes/Notes4", "./notes/Notes5", "../digg/Digg", "angular2/http", "../logout/Logout", "./contact/Contact"], function(exports_1) {
    ...
    var core_1, router_1, router_2, MenuItem_1, Menu_1, CommBroker_1, Conts_1, Sliderpanel_1, Properties_1, Notes1_1, Notes2_1, Notes3_1, Notes4_1, Notes5_1, Digg_1, http_1, Logout_1, Contact_1;
    var App2;
    return {
        setters:[
            function (core_1_1) {
                ...
                App2 = __decorate([
                    core_1.Component({
                        ...
                        directives: [router_1.ROUTER_DIRECTIVES, router_2.RouterLink, Menu_1.Menu, MenuItem_1.MenuItem, Sliderpanel_1.Sliderpanel, Properties_1.Properties, Digg_1.Digg,
                            Notes1_1.Notes1, Notes2_1.Notes2, Notes3_1.Notes3, Notes4_1.Notes4, Notes5_1.Notes5, Logout_1.Logout, Contact_1.Contact]
                    }), 

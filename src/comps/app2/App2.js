System.register(['angular2/core', 'angular2/router', "../sideMenu/MenuItem", "../sideMenu/Menu", "../../services/CommBroker", "../../Conts", "../sliderpanel/Sliderpanel", "./properties/Properties", "./notes/Notes", "./notes/Notes1", "./notes/Notes2", "./notes/Notes3", "./notes/Notes4", "./notes/Notes5", "../digg/Digg", "angular2/http", "../logout/Logout", "./contact/Contact", "../dividerpanel/DividerPanel", "../modaldialog/ModalDialog"], function(exports_1) {
    ...
    var core_1, router_1, router_2, MenuItem_1, Menu_1, CommBroker_1, Conts_1, Sliderpanel_1, Properties_1, Notes_1, Notes1_1, Notes2_1, Notes3_1, Notes4_1, Notes5_1, Digg_1, http_1, Logout_1, Contact_1, DividerPanel_1, ModalDialog_1;
    var App2;
    return {
        setters:[
            function (core_1_1) {

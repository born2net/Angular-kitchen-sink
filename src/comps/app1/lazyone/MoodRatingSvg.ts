 ...
 * reference:
 * Ben Nadel at
 *  http://www.bennadel.com/blog/3132-practical-svg-by-chris-coyier.htm
**/
import {
    Component,
    Output
...
export class MoodRatingSvg {
    ...
    public selectRating(newRating: number): void {
        ...
        ( newRating === this.value ) ? this.valueChange.emit(0) : this.valueChange.emit(newRating);

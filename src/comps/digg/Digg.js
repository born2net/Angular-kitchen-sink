System.register(['@angular/core', '@angular/platform-browser/src/browser/browser_adapter', "../../../src/Conts", "rxjs/Observable", "../../../src/comps/digg/DiggLoader", "../../services/CommBroker", 'rxjs/add/observable/from', 'rxjs/add/operator/do', 'rxjs/add/operator/debounceTime', 'rxjs/add/operator/distinctUntilChanged'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, browser_adapter_1, Conts_1, Observable_1, DiggLoader_1, CommBroker_1;
    var Digg;
    return {
        setters:[
            function (core_1_1) {

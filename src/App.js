    ...
    return {
        ...
        execute: function() {
            ...
            App = (function () {
                ...
                App = __decorate([
                    core_1.NgModule({
                        imports: [platform_browser_1.BrowserModule, forms_1.FormsModule, http_1.HttpModule, http_1.JsonpModule, forms_1.ReactiveFormsModule, App_routes_1.routing],
                        providers: [],
